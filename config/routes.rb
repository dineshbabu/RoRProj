NewConfApp::Application.routes.draw do
  ...
  match '/files/stopcmlistener' => 'files#stop_cm_listener', :via => :get
  match '/files/testcmlistener' => 'files#test_cm_listener', :via => :get
  match '/files/testcmhome' => 'files#test_cm_home', :via => :get
  ...
  match '/files/stoptomcatlistener' => 'files#stop_tomcat_listener', :via => :get
  match '/files/testtomcathome' => 'files#test_tomcat_home', :via => :get
  match '/files/testtomcatport' => 'files#test_tomcat_port', :via => :get
  ...
  match '/files/testalmhome' => 'files#test_alm_home', :via => :get 
  
  match 'files/editdeployment' => 'files#edit_deployment', :via => :get  
  match 'files/updatedeployment' => 'files#update_deployment', :via => :post
